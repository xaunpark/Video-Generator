...
class VideoEditor:
    ...
    def __init__(self):
        """Khởi tạo VideoGenerator với cấu hình cần thiết."""
        ...
        logger.info(f"VideoGenerator đã khởi tạo. Kích thước video: {self.width}x{self.height}, FPS: {self.fps}")
    
    def generate_video(self, script, media_items, audio_dir, output_path):
        """
