    ...
    def generate_script(self, article, style="informative"):
        ...
        try:
            ...
            if style == "controversial":
                ...
                6. End with a provocative question that encourages viewers to comment
                7. Keep each scene short and intense (1-2 sentences)
                
                Format the script with the following structure (important: maintain this exact format):
                
                #SCENE 1#
                [Shocking opening statement/question]
                
                #SCENE 2#
                [Present first controversial perspective]
                
                #SCENE 3#
                [Present opposing controversial perspective]
                
                #SCENE 4#
                [Escalate tension by highlighting real-world impacts]
                
                #SCENE 5#
                [Add expert opinions that conflict with each other]
                
                #SCENE 6#
                [Conclude with provocative question that encourages debate]
                """
            else:
