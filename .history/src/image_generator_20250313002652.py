...
class ImageGenerator:
    ...
    def _get_font(self, size=40):
        ...
        Args:
            size (int): Kích thước font
            
        Returns:
            PIL.ImageFont: Font với kích thước đã chỉ định
        """
        font_path = os.path.join(self.fonts_dir, "Roboto-Bold.ttf")
        ...
        try:
            ...
            logger.warning(f"Không thể tải font {font_path}: {str(e)}")
            logger.warning("Sử dụng font mặc định")
