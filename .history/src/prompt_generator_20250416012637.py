...
style_configs = {
    ...
    "instructions": [ # Lấy từ prompt và điều chỉnh
        ...
        # KHÔNG cần instruction về việc tạo từng Part vì project đã làm theo chapter.
    ],
    ...
    "scene_range": (150, 350), # Ví dụ: tăng lên
    "target_audience": "60+" # Thêm trường target_audience
},    
}
