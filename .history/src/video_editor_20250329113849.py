        ...
        if media_type == 'image':
            ...
            try:
                ...
                if animation_type == "none":
                    ...
                    # Hiệu ứng zoom dựa trên hàm sin
                    vf_filter = f"zoompan=z='1+{intensity}*sin(2*PI*on/d)':d={int(self.fps*audio_duration)}:s={self.width}x{self.height}" # Sử dụng on và PI
                else:
