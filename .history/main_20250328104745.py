...
def select_script_style(article, categories=None):
    ...
    if has_controversial_content:
        ...
        # Informative style for technology/science
        ...
        # Conversational style for entertainment/lifestyle
        ...
        # Dramatic style for politics/business/world news
        logger.info(f"Article in {article_category} category, using dramatic style")
        return "dramatic"
    else:
        # Default to informative style
...
def main():
    ...
    # Generate script with intelligent style selection
    script_generator = ScriptGenerator()
    selected_style = select_script_style(selected_article, categorized)
    logger.info(f"Selected '{selected_style}' style based on article content and category")
